...
>
    ...
    <div className="flex flex-col px-5 py-4 gap-2">
        ...
        <Link
            to={`/detail/${item.id}`}
            className="mt-2 px-5 py-2 rounded-md border border-blue-400/60 bg-blue-500/10 text-sm font-semibold text-blue-300 transition-all duration-300 hover:bg-blue-500/20 hover:border-blue-300 hover:text-white hover:shadow-[0_0_15px_rgba(59,130,246,0.25)] active:scale-95 flex justify-center"
        >
            See Detail
        </Link>
