...
const footerLinks = {
    Explore: ["Models", "Finder", "Electric"],
...
const Footer = () => {
    ...
    return (
        <footer className="bg-[#050505] text-white border-t border-white/10">
            <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-20 lg:gap-50 border-b border-gray-600">
